...
mod tests {
    ...
    fn test_part1_example() {
        let input = std::fs::read_to_string("inputs/day02/example1.txt").expect("Example file not found");
    ...
    #[test]
    fn test_part1_input() {
        let input = std::fs::read_to_string("inputs/day02/input.txt").expect("Input file not found");
